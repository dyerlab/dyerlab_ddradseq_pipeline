...
def main():
    fastqfile = open("/gpfs_fs/hohensteinta/PROW_reads/test/raw/PL1head.fastq", 'r')
    barcodefile = open("/gpfs_fs/hohensteinta/PROW_reads/test/barcodes/PROW_barcodes", 'r')
    # except:
    #  print 'Usage: python fix_seqs.py fastqfile.fq barcode.txt output.fastq'
    # quit()


    fixed_seqfile = open("/gpfs_fs/hohensteinta/PROW_reads/test/raw/PL1head_f.fastq", 'w')
