...
def main():
    fastqfile = open("/gpfs_fs/hohensteinta/PROW_reads/raw/PL3.fastq", 'r')
    barcodefile = open("/gpfs_fs/hohensteinta/PROW_reads/barcodes/PROW_barcodes", 'r')
    # except:
    #  print 'Usage: python fix_seqs.py fastqfile.fq barcode.txt output.fastq'
    # quit()


    fixed_seqfile = open("/gpfs_fs/hohensteinta/PROW_reads/raw/PL3_f.fastq", 'w')
