...
# edit this to match your directory set-up
def main():
    fastqfile = open("<raw reads file path>", 'r')
    barcodefile = open("<barcodes file path>", 'r')
    # except:
    #  print 'Usage: python fix_seqs.py fastqfile.fq barcode.txt output.fastq'
    # quit()

    # edit this match your directory set-up
    fixed_seqfile = open("<raw reads file path>", 'w')

    # edit this to match your restriction enzyme selections
